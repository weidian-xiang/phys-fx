...
CI_RUN_URL=https://github.com/weidian-xiang/phys-fx/actions/runs/32446012488
CI_PUSH_RUN_URL=https://github.com/weidian-xiang/phys-fx/actions/runs/32446012488
CI_PR_RUN_URL=https://github.com/weidian-xiang/phys-fx/actions/runs/32445703453
RELEASE_URL=https://gitee.com/xiang-weidian/phys-fx/releases/tag/v0.5.0
...
- v0.3.0 Release：<https://gitee.com/xiang-weidian/phys-fx/releases/tag/v0.3.0>。
- v0.4.0 Release：<https://gitee.com/xiang-weidian/phys-fx/releases/tag/v0.4.0>。
- v0.5.0 Release：<https://gitee.com/xiang-weidian/phys-fx/releases/tag/v0.5.0>。
